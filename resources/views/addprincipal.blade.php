            ...
            <div class="col-md-8"> <!-- Increase the column size to make the card wider -->
                <div class="card" style="width: 1000px; opacity: 0.8;"> <!-- Adjust the width of the card -->
                    <div class="card-body">
                        ...
                        <center><h5>PRINCIPAL'S INFORMATION</h5></center>
                        <br>
                        
                        <form action="/principals" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="email" name="rank" placeholder="Rank">
                                </div>
                                <br>
                            </div>
                           <center> <button type="submit" class="btn btn-primary" style="height: 50px; width: 600px;">ADD PRINCIPAL'S INFORMATION</button></center>
                        </form>
                    </div>
                </div>
            </div>
