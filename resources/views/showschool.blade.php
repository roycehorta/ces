            ...
            <div class="col-md-8"> <!-- Increase the column size to make the card wider -->
                <div class="card" style="width: 1000px; opacity: 0.8;"> <!-- Adjust the width of the card -->
                    <div class="card-body">
                        ...
                        <center><h5>VIEW SCHOOL INFORMATION</h5></center>
                        <br>

                        <form action="/schools/{{$school->id}}" method="POST" action="" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="school_id" class="form-label">School Identification Number</label>
                                    <input type="text" class="form-control" id="school_id" name="school_id" value="{{ $school->school_id }}" disabled>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="school_name" class="form-label">School Name</label>
                                    <input type="text" class="form-control" id="school_name" name="school_name" value="{{ $school->school_name }}" disabled>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="cluster" class="form-label">Cluster</label>
                                    <input type="text" class="form-control" id="cluster" name="cluster" value="{{ $school->cluster }}"  disabled>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="address" class="form-label">School Address</label>
                                    <input type="text" class="form-control" id="address" name="address" value="{{ $school->address }}" disabled>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="contact_number" class="form-label">School Contact Number</label>
                                    <input type="text" class="form-control" id="contact_number" name="contact_number" value="{{ $school->contact_number }}" disabled>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="email" class="form-label">School Email</label>
                                    <input type="text" class="form-control" id="email" name="email" value="{{ $school->email }}" disabled>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="division_name" class="form-label">Division Name</label>
                                    <input type="text" class="form-control" id="division_name" name="division_name" value="{{ $school->division_name }}" disabled>
                                </div>
                                <br>
                            </div>
                        </form>
